...
class NormalTopicInput extends StatefulWidget {
  final Topic? topic;
  ...
  @override
  State<NormalTopicInput> createState() => NormalTopicInputState();
}

class NormalTopicInputState extends State<NormalTopicInput> {
  ...
  @override
  void didUpdateWidget(NormalTopicInput oldWidget) {
  ...
  String _showText({required String enabledText}) {
    ...
    if (topic != null) {
      if (topic.isDummy) return 'Moment deleted';
      if (topic.isClosed) return 'Moment closed';
    }
        ...
        Container(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                IconButton(
                  onPressed: (!_enabled || _isUploading)
                      ? null
                      : _handleSendImageMessage,
                  icon: _isUploading
                      ? const SizedBox(
                          width: 20,
                          height: 20,
