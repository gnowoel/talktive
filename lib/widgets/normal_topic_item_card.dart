...
class NormalTopicItemCard extends StatefulWidget {
  final Topic topic;
  final Function(Topic) onRemove;
  final Function(Topic) onRestore;

  const NormalTopicItemCard({
    super.key,
    required this.topic,
  ...
  @override
  State<StatefulWidget> createState() => _NormalTopicItemCardState();
}

class _NormalTopicItemCardState extends State<NormalTopicItemCard> {
  ...
  void _handleDismiss(DismissDirection direction) {
    ...
    ScaffoldMessenger.of(context)
        ...
        .closed
        .then((reason) {
      // Only mute the moment if the SnackBar was closed by timeout
