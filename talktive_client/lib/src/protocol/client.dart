...
import 'package:serverpod_auth_core_client/serverpod_auth_core_client.dart'
    as _i4;
import 'package:talktive_client/src/protocol/resident.dart' as _i5;
import 'package:talktive_client/src/protocol/daily_reward.dart' as _i6;
import 'package:talktive_client/src/protocol/lounge.dart' as _i7;
...
import 'package:talktive_client/src/protocol/lounge_member_with_profile.dart'
    as _i9;
import 'package:talktive_client/src/protocol/message.dart' as _i10;
import 'package:talktive_client/src/protocol/moment.dart' as _i11;
import 'package:talktive_client/src/protocol/moment_like.dart' as _i12;
import 'package:talktive_client/src/protocol/moment_comment.dart' as _i13;
import 'package:talktive_client/src/protocol/user_notification.dart' as _i14;
import 'package:talktive_client/src/protocol/private_chat.dart' as _i15;
import 'package:talktive_client/src/protocol/private_chat_with_profile.dart'
    as _i16;
import 'package:talktive_client/src/protocol/report.dart' as _i17;
import 'package:talktive_client/src/protocol/user_profile_view.dart' as _i18;
import 'package:talktive_client/src/protocol/user_summary.dart' as _i19;
import 'package:talktive_client/src/protocol/search_all_results.dart' as _i20;
import 'package:talktive_client/src/protocol/discovery_feed.dart' as _i21;
import 'package:talktive_client/src/protocol/greetings/greeting.dart' as _i22;
...
class EndpointGamification extends _i2.EndpointRef {
  ...
  _i3.Future<_i5.Resident> getGamificationData() =>
      caller.callServerEndpoint<_i5.Resident>(
        'gamification',
        'getGamificationData',
        {},
      );
  ...
  _i3.Future<_i6.DailyReward> claimDailyReward() =>
      caller.callServerEndpoint<_i6.DailyReward>(
        'gamification',
        'claimDailyReward',
        {},
      );
  ...
  _i3.Future<List<_i6.DailyReward>> getRewardHistory({required int limit}) =>
      caller.callServerEndpoint<List<_i6.DailyReward>>(
        'gamification',
        'getRewardHistory',
        {'limit': limit},
      );
...
class EndpointLounge extends _i2.EndpointRef {
  ...
  }) => caller.callServerEndpoint<_i7.Lounge>(
    'lounge',
    'createLounge',
    {
      'name': name,
  ...
  _i3.Future<List<_i8.LoungeWithMembership>> listMyLounges({
    required int limit,
    required int offset,
  }) => caller.callServerEndpoint<List<_i8.LoungeWithMembership>>(
    'lounge',
    'listMyLounges',
    {
      'limit': limit,
  ...
  _i3.Future<_i7.Lounge> getLounge(int loungeId) =>
      caller.callServerEndpoint<_i7.Lounge>(
        'lounge',
        'getLounge',
        {'loungeId': loungeId},
  ...
  _i3.Future<List<_i7.Lounge>> searchPublicLounges(
    ...
    required int limit,
    required int offset,
  }) => caller.callServerEndpoint<List<_i7.Lounge>>(
    'lounge',
    'searchPublicLounges',
    {
      'query': query,
  ...
  _i3.Future<List<_i9.LoungeMemberWithProfile>> getLoungeMembersWithProfiles(
    int loungeId,
  ) => caller.callServerEndpoint<List<_i9.LoungeMemberWithProfile>>(
    'lounge',
  ...
  _i3.Future<List<_i5.Resident>> getLoungeMembers(int loungeId) =>
      caller.callServerEndpoint<List<_i5.Resident>>(
        'lounge',
        'getLoungeMembers',
        {'loungeId': loungeId},
      );
...
class EndpointMoment extends _i2.EndpointRef {
  ...
  }) => caller.callServerEndpoint<_i11.Moment>(
    'moment',
    'postMoment',
    {
      'imageUrl': imageUrl,
  ...
  _i3.Future<List<_i11.Moment>> listMoments({
    required int limit,
    int? lastId,
  }) => caller.callServerEndpoint<List<_i11.Moment>>(
    'moment',
    'listMoments',
    {
      'limit': limit,
  ...
  _i3.Future<List<_i12.MomentLike>> getMomentLikes(int momentId) =>
      caller.callServerEndpoint<List<_i12.MomentLike>>(
        'moment',
        'getMomentLikes',
        {'momentId': momentId},
      );
  ...
  _i3.Future<_i13.MomentComment> addComment(
    int momentId,
    String text,
  ) => caller.callServerEndpoint<_i13.MomentComment>(
    'moment',
    'addComment',
    {
      'momentId': momentId,
  ...
  _i3.Future<List<_i13.MomentComment>> getMomentComments(
    int momentId, {
    required int limit,
  }) => caller.callServerEndpoint<List<_i13.MomentComment>>(
    'moment',
    'getMomentComments',
    {
      'momentId': momentId,
...
class EndpointNotification extends _i2.EndpointRef {
  ...
  _i3.Future<List<_i14.UserNotification>> getUserNotifications({
    required int limit,
    required int offset,
...
class EndpointPrivateChat extends _i2.EndpointRef {
  ...
  _i3.Future<_i15.PrivateChat> getOrCreatePrivateChat(
    String otherUserId, {
    String? initialMessage,
  }) => caller.callServerEndpoint<_i15.PrivateChat>(
    'privateChat',
  ...
  _i3.Future<List<_i16.PrivateChatWithProfile>> listPrivateChats() =>
      caller.callServerEndpoint<List<_i16.PrivateChatWithProfile>>(
        'privateChat',
        'listPrivateChats',
        {},
      );
  ...
  _i3.Future<_i16.PrivateChatWithProfile> getPrivateChatDetails(
    int channelId,
  ) => caller.callServerEndpoint<_i16.PrivateChatWithProfile>(
    'privateChat',
...
class EndpointResident extends _i2.EndpointRef {
  ...
  _i3.Future<_i5.Resident?> getResidentById(String userId) =>
      caller.callServerEndpoint<_i5.Resident?>(
        'resident',
        'getResidentById',
        {'userId': userId},
  ...
  _i3.Future<_i5.Resident> updateCustomAvatar(String? customAvatarUrl) =>
      caller.callServerEndpoint<_i5.Resident>(
        'resident',
        'updateCustomAvatar',
        {'customAvatarUrl': customAvatarUrl},
  ...
  _i3.Future<_i18.UserProfileView?> getUserProfile(String userId) =>
      caller.callServerEndpoint<_i18.UserProfileView?>(
        'resident',
        'getUserProfile',
        {'userId': userId},
      );
...
class EndpointSearch extends _i2.EndpointRef {
  ...
  _i3.Future<List<_i19.UserSummary>> searchUsers(
    String query, {
    required int limit,
  }) => caller.callServerEndpoint<List<_i19.UserSummary>>(
    'search',
    'searchUsers',
    {
      'query': query,
  ...
  _i3.Future<List<_i11.Moment>> getTrendingMoments({required int limit}) =>
      caller.callServerEndpoint<List<_i11.Moment>>(
        'search',
        'getTrendingMoments',
        {'limit': limit},
  ...
  _i3.Future<List<_i7.Lounge>> getPopularLounges({required int limit}) =>
      caller.callServerEndpoint<List<_i7.Lounge>>(
        'search',
        'getPopularLounges',
        {'limit': limit},
  ...
  _i3.Future<List<_i19.UserSummary>> getActiveUsers({required int limit}) =>
      caller.callServerEndpoint<List<_i19.UserSummary>>(
        'search',
        'getActiveUsers',
        {'limit': limit},
  ...
  _i3.Future<_i20.SearchAllResults> searchAll(
    String query, {
    required int limit,
  }) => caller.callServerEndpoint<_i20.SearchAllResults>(
    'search',
    'searchAll',
    {
      'query': query,
  ...
  _i3.Future<List<_i19.UserSummary>> discoverUsersByInterests({
    required int limit,
  }) => caller.callServerEndpoint<List<_i19.UserSummary>>(
    'search',
  ...
  _i3.Future<List<_i19.UserSummary>> discoverUsersByLanguages({
    required int limit,
  }) => caller.callServerEndpoint<List<_i19.UserSummary>>(
    'search',
  ...
  _i3.Future<_i21.DiscoveryFeed> getDiscoveryFeed({required int limit}) =>
      caller.callServerEndpoint<_i21.DiscoveryFeed>(
        'search',
        'getDiscoveryFeed',
        {'limit': limit},
      );
