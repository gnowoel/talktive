...
final _peepholeMessageProvider = FutureProvider.family<Message?, int>((
  ...
  final messages = await client.message.listMessages(
    channelId,
    limit: 1,
    offset: 0,
  );
...
class PeepholeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final initialMessageAsync = ref.watch(
      _peepholeMessageProvider(chatItem.chat.channelId),
    );
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Bio
                  if (otherResident.bio != null &&
                      otherResident.bio!.isNotEmpty)
                    Container(
                      padding: const EdgeInsets.all(AppTheme.duoSpacingLarge),
                      decoration: BoxDecoration(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        await ref
                            ...
                            .respondToInvite(chatItem.chat.channelId, true);
                        if (context.mounted) {
  ...
  Widget _buildMomentsButton(
    ...
    return DuoButton(
      ...
      color: AppTheme.duoBlue.withValues(
        alpha: 0.8,
      ), // Slightly transparent for dark theme
      width: double.infinity,
      onPressed: () {
        context.push(
          '/user/$userId/moments?name=${Uri.encodeComponent(userName)}',
        );
      },
    );
  }
