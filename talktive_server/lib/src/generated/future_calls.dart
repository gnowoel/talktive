...
import '../future_calls/daily_cleanup.dart' as _i3;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'DailyCleanupCallInvokeFutureCall': DailyCleanupCallInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final dailyCleanupCall = _DailyCleanupCallFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _DailyCleanupCallFutureCallDispatcher {
  _DailyCleanupCallFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invoke(_i1.SerializableModel? object) {
    return _invokeFutureCall(
      'DailyCleanupCallInvokeFutureCall',
      object,
    );
  }
}

class DailyCleanupCallInvokeFutureCall
  ...
  _i2.Future<void> invoke(
    ...
    await _i3.DailyCleanupCall().invoke(
      session,
      object,
    );
  }
