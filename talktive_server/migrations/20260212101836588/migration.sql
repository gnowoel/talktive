...
ALTER TABLE "report" ADD COLUMN "status" text NOT NULL DEFAULT 'pending'::text;
ALTER TABLE "report" ADD COLUMN "adminNotes" text;
ALTER TABLE "report" ADD COLUMN "resolvedAt" timestamp without time zone;
CREATE INDEX "report_status_idx" ON "report" USING btree ("status", "createdAt");
--
-- ACTION ALTER TABLE
--
ALTER TABLE "resident" ADD COLUMN "isAdmin" boolean NOT NULL DEFAULT false;
ALTER TABLE "resident" ADD COLUMN "isBanned" boolean NOT NULL DEFAULT false;
--
-- ACTION CREATE TABLE
--
