...
CREATE TABLE "message" (
    ...
    "senderAvatar" text,
    "senderReputation" bigint NOT NULL
);
...
CREATE TABLE "moment" (
    ...
    "authorReputation" bigint NOT NULL
);
...
--
-- Class RateLimit as table rate_limit
--
...
--
-- Class UserStreak as table user_streaks
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('talktive', '20260223153101612', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260223153101612', "timestamp" = now();
