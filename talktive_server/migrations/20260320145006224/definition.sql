...
CREATE TABLE "resident" (
    ...
    "showEnhancedPeephole" boolean NOT NULL DEFAULT true,
    "showGoldenRing" boolean NOT NULL DEFAULT true,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('talktive', '20260320145006224', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260320145006224', "timestamp" = now();
