...
CREATE TABLE "channel_member" (
    ...
    "lastReadAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class DailyReward as table daily_rewards
--
...
CREATE TABLE "message" (
    ...
    "recalledAt" timestamp without time zone,
...
--
-- Class MomentComment as table moment_comments
--
...
--
-- Class MomentLike as table moment_likes
--
...
--
-- Class PrivateChat as table private_chat
--
...
CREATE INDEX "report_status_idx" ON "report" USING btree ("status", "createdAt");

--
-- Class Resident as table resident
--
CREATE TABLE "resident" (
    ...
    "premiumTrialExpires" timestamp without time zone,
    "trialCount" bigint NOT NULL DEFAULT 0,
    "showOnlineStatus" boolean NOT NULL DEFAULT true,
    "showReadReceipts" boolean NOT NULL DEFAULT true,
    "showTypingIndicator" boolean NOT NULL DEFAULT true,
    "showVoiceMessages" boolean NOT NULL DEFAULT true,
    "showNeighborsDiscovery" boolean NOT NULL DEFAULT true,
    "allowDiscovery" boolean NOT NULL DEFAULT true,
    "showCustomAvatar" boolean NOT NULL DEFAULT true,
    "showImagesInPlaza" boolean NOT NULL DEFAULT true,
    "showImagesInLounges" boolean NOT NULL DEFAULT true,
    "showImagesInPrivateChats" boolean NOT NULL DEFAULT true,
    "showImagesInMoments" boolean NOT NULL DEFAULT true,
    "showOthersOnlineStatus" boolean NOT NULL DEFAULT true,
    "showOthersReadReceipts" boolean NOT NULL DEFAULT true,
    "showOthersTypingIndicators" boolean NOT NULL DEFAULT true,
    "keepPrivateChats" boolean NOT NULL DEFAULT true,
...
--
-- Class Block as table user_block
--
...
--
-- Class UserLike as table user_like
--
...
-- Indexes
CREATE UNIQUE INDEX "user_like_idx" ON "user_like" USING btree ("senderId", "receiverId");

--
-- Class UserNotification as table user_notifications
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('talktive', '20260329050946972', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260329050946972', "timestamp" = now();
