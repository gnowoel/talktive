...
import 'package:talktive_server/src/generated/user_streak.dart' as _i20;
import 'package:talktive_server/src/generated/daily_reward.dart' as _i21;
import 'package:talktive_server/src/generated/user_profile_view.dart' as _i22;
...
class _StreakEndpoint {
  ...
  _i3.Future<_i20.UserStreak?> getUserStreak(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
  ...
  _i3.Future<_i21.DailyReward> claimDailyReward(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i21.DailyReward>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i21.DailyReward>> getRewardHistory(
    _i1.TestSessionBuilder sessionBuilder, {
    required int limit,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i21.DailyReward>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _UserProfileEndpoint {
  ...
  _i3.Future<_i22.UserProfileView?> getUserProfile(
    _i1.TestSessionBuilder sessionBuilder,
    String userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i22.UserProfileView?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
