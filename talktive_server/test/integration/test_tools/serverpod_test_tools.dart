...
import 'package:talktive_server/src/generated/group_with_membership.dart'
    as _i7;
import 'package:talktive_server/src/generated/resident.dart' as _i8;
...
class TestEndpoints {
  ...
  late final _ImageEndpoint image;
...
class _GroupEndpoint {
  ...
  _i3.Future<List<_i8.Resident>> getGroupMembers(
    _i1.TestSessionBuilder sessionBuilder,
    int groupId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i8.Resident>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'imageUrl': imageUrl}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
...
class _ResidentEndpoint {
  ...
  _i3.Future<_i8.Resident?> getResidentById(
    _i1.TestSessionBuilder sessionBuilder,
    String userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i8.Resident> updateResident(
    _i1.TestSessionBuilder sessionBuilder, {
    required String name,
    required String avatar,
    required String gender,
